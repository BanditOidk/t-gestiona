...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-10-2022 a las 06:04:54
...
CREATE TABLE `empleados` (
  ...
  `apellido` varchar(16) COLLATE utf8_spanish_ci NOT NULL,
...
(10002, '1970-06-02', 'Bezalel', 'Simmel', 'F', '1985-11-21'),
...
(1, 'Laptop Asus Intel Core i5 ', 31, 2400),
(2, 'All in One HP AMD Ryzen 5600g', 16, 2800),
(3, 'Laptop Toshiba Intel Core i7', 31, 3800),
(4, 'All in One DELL AMD Ryzen 3200g', 27, 1800),
(5, 'IPhone 12 Pro 256gb', 19, 4500),
(6, 'All In One DELL Intel Core i7', 22, 2800);
...
INSERT INTO `ventas` (`id_venta`, `nombre_cliente`, `descripcion`, `total`, `fecha`) VALUES
(1, 'Roberto Gómez Alcántara', 'Laptop Asus Core i5', 2400, '2022-10-04'),
(2, 'Ana Solís García', 'All In One DELL Intel Core i7', 2800, '2022-09-29'),
(3, 'Patricio Lamou Arderiu', 'IPhone 12 Pro 256gb', 4500, '2022-08-17'),
(5, 'Úrsula Ramos Quiroz', 'Laptop Asus Core i7', 2800, '2022-10-19'),
(7, 'Cesar Villanueva Cardenas', 'All in One HP AMD Ryzen 5600g	', 2800, '2022-10-11');
